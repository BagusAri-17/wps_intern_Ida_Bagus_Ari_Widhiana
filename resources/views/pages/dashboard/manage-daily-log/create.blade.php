        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-md">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('manage-daily-log.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                            {{-- Description Log Input --}}
                            <div>
                                <x-input-label for="description" :value="__('Log Description')" />
                                <textarea id="description" class="block w-full mt-1 text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" name="description" :value="old('name')" placeholder="Input description log here..." rows="4"></textarea>
                            ...
                            <div>
                                ...
                                <input id="proof_of_employment" class="block w-full mt-1 text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm file:cursor-pointer file:border-0 file:py-2.5 file:px-4 file:bg-gray-700 file:hover:bg-indigo-500 duration-500 transition-all file:text-gray-300" type="file" name="proof_of_employment" :value="old('proof_of_employment')">
