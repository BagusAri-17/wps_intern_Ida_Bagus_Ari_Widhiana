                    ...
                    <form method="POST" action="{{ route('manage-user.update', $user->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                            ...
                            <div class="col-span-2">
                                ...
                                <x-text-input id="name" class="block w-full mt-1 text-sm" type="text" name="name" :value="old('name', $user->name)" placeholder="Input employee name here..." />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block w-full mt-1 text-sm" type="email" name="email" :value="old('email', $user->email)" placeholder="Input email here..." />
