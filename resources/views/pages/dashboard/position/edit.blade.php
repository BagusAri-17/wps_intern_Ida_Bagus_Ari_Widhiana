        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-md">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('manage-position.update', $position->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block w-full mt-1 text-sm" type="text" name="name" :value="old('name',$position->name)" placeholder="Input position name here..." />
